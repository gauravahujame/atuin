...
If you prefer running the daemon yourself (for example via systemd/tmux), keep `autostart = false` and run `atuin daemon start`.
Once it's ready for wider use, we will handle this setup for you.
